...
class DecisionManager extends AbstractManager {
  ...
  async read(id) {
    ...
    const [rows] = await this.database.query(
      `SELECT decision.decision_date, decision.decision_title, CONCAT(user.firstname,' ', user.lastname) AS name, decision.status, paragraph.paragraph_details, paragraph.paragraph_impact, paragraph.paragraph_benefits, paragraph.paragraph_risks, paragraph.paragraph_first_decision, paragraph.paragraph_decision, paragraph.paragraph_finale_decision, paragraph.decision_id
      FROM ${this.table}
